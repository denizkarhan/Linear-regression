...
class linear_regression :
    ...
    def plot_value(self) :
        ...
        print(self.min_x, self.tmp_theta_0, self.tmp_theta_1)
        print(self.estimatePrice(self.min_x), self.estimatePrice(self.max_x))
        exit(0)
    

        plt.plot([self.min_x, self.max_x], [self.estimatePrice(self.min_x), self.estimatePrice(self.max_x)])
        plt.axis([self.min_x - abs(self.max_x * 0.1), self.max_x + abs(self.max_x * 0.1), self.min_y - abs(self.max_y * 0.1), self.max_y + abs(self.max_y * 0.1)])
        plt.show()
